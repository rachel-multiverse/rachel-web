defmodule Rachel.Game.IntegrationBugHuntTest do
  ...
  describe "Bug hunting - specific scenarios" do
    test "Ace nomination should work" do
      ...
      game = %GameState{
        players: players,
        discard_pile: [Card.new(:hearts, 10)], # Hearts 10 on top
    ...
    test "Card matching with suit/rank" do
      players = [
        %{id: "p1", name: "Player 1", hand: [
          Card.new(:hearts, 12),  # Matches suit
          Card.new(:clubs, 10),   # Matches rank  
          Card.new(:spades, 7)    # Matches neither
        ], status: :playing}
      ]
    ...
    test "Skip handling" do
      players = [
        %{id: "p1", name: "Player 1", hand: [Card.new(:hearts, 7), Card.new(:diamonds, 3)], status: :playing},
        %{id: "p2", name: "Player 2", hand: [Card.new(:spades, 5)], status: :playing},
    ...
    test "Simple Black Jack attack and Red Jack counter" do
      ...
      game = %GameState{
        players: players,
        discard_pile: [Card.new(:spades, 10)], # Spades 10
      ...
      assert game.pending_attack == nil  # Should be cancelled
    end
  end
end